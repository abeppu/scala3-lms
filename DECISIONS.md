...
- [Decision] Legacy `eval.scala` is carried forward as a Scala 3 `DslCompile`-based evaluator-specialization tutorial, rather than reintroducing a separate `CompileScala`-style driver layer.
